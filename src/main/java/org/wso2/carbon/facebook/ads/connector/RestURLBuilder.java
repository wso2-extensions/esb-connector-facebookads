...
public class RestURLBuilder extends AbstractConnector {
    ...
    public void connect(MessageContext messageContext) throws ConnectException {
        ...
        try {
            String accessToken = (String) getParameter(messageContext, Constants.PROPERTY_ACCESS_TOKEN);
            ...
            String urlQuery = "?" + Constants.ACCESS_TOKEN + "=" + URLEncoder.encode(accessToken, encoding);
